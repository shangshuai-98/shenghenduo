...
cookies = {
    ...
    "_m_h5_tk": "39e359d72a407d05bf0579f9a61805d7_1736080283492",
    "_m_h5_tk_enc": "3f6b209f5eeb9a5c1316af8e291b0f05",
...
# 订单接口
url = "https://h5api.m.goofish.com/h5/mtop.idle.web.trade.bought.list/1.0/"
...
sign = f'{token}&{t}&{34839810}&{data.get('data')}'
# print(sign)
...
if '令牌过期' in ret[0]:
    ...
    response = requests.post(url, headers=headers, cookies=cookies, params=params, data=data)
    print(response.text)
resultList = json.loads(response.text).get('data').get('resultList')
# print(resultList[0])
